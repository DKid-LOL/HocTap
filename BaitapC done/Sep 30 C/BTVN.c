/* tao struct person gom year, sex, address, hobby
   tao struct nhan vien gom name, person, position, salary.
   tao menu : +----------------------------------------------------------------------------------------------+
                |                          KHONG KHO KHI TA BIET TU DUY                      |
                | 90% THANH CONG PHU THUOC VAO SU CHAM CHI CAN CU |
                +----------------------------------------------------------------------------------------------+
                |1. input  |2. output |3. search |4. add element |5. sort| 6. exit                              |
            +----------------------------------------------------------------------------------------------+ \
    case  1 : nhap du lieu.
    case 2 : xuat du lieu ra man hinh
    case 3 : tim kiem nguoi que ha noi
    case 4 : them 1 phan tu o vi tri ma nguoi dung nhap vao
    case 5 : sap xep mang theo year
    case 6 : thoat */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
struct NhanVien* danhSachNhanVien = NULL;
int soLuongNhanVien = 0;
int kichThuocDanhSach = 10; // Kích thước ban đầu của danh sách
...
int main() {
    int luaChon;
    danhSachNhanVien = (struct NhanVien*)malloc(kichThuocDanhSach * sizeof(struct NhanVien));
    ...
    do {
        ...
        printf("+----------------------------------------------------------------------------------------------+\n");
        printf("|1. input  |2. output |3. search |4. add element |5. sort| 6. exit                             |\n");
        printf("+----------------------------------------------------------------------------------------------+\n");
        ...
        switch (luaChon) {
            case 1:
            printf("so luong nhan vien : "); scanf("%d" , &soLuongNhanVien);
            for (int i = 0;)
                if (soLuongNhanVien < kichThuocDanhSach) {
